        ...
        <div className="col-lg-8">
          <div className="class-details-text">
            <div className="cd-pic">
              <img src="img copy/classes/class-details/class-detailsl.jpg" alt="" />
            </div>
              ...
              <div className="row">
                <div className="col-md-6">
                  <div className="cd-trainer-pic">
                    <img
                      src="img copy/classes/class-details/trainer-profile.jpg"
                      alt=""
                    />
                  </div>
                </div>
          ...
          <div className="sidebar-option">
            ...
            <div className="so-latest">
              ...
              <div
                ...
                data-setbg="img copy/letest-blog/latest-1.jpg"
              >
            ...
            <div
              ...
              data-setbg="img/sidebar-banner.jpg"
            >
